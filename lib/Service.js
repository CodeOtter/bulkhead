...
module.exports = function(modelName, criteriaMapping) {
	...
	// This allows the contents of the /api folder in the NPM package for the extended service to be added to SailsJS  like a plugin. 
	self.plugin = Bootstrap.add();
